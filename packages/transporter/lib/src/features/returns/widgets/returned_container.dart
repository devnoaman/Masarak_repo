...
import 'package:transporter/src/features/returns/utils/plate_handler.dart';
import 'package:transporter/src/features/returns/widgets/return_trip_operations.dart';
    ...
    return Padding(
      ...
      child: Theme(
        ...
        child: ExpansionTile(
          ...
          collapsedBackgroundColor: context.theme.primaryColor,
