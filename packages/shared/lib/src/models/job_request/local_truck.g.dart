...
_LocalTruck _$LocalTruckFromJson(Map<String, dynamic> json) => _LocalTruck(
...
Map<String, dynamic> _$LocalTruckToJson(_LocalTruck instance) =>
    <String, dynamic>{
      'id': instance.id,
