...
import 'package:masarak_transporter/widgets/barcode/scanner_error_widget.dart';
      ...
      child: Column(
        ...
        children: [
                ...
                body: Stack(
                  ...
                  children: [
                    MobileScanner(
                      fit: BoxFit.cover,
                      onDetect: (barcodes) {
                        log(barcodes.barcodes.first.rawValue ?? 'sss');
          ...
          Container(
            ...
            child: Center(
              child: Text('قم بتوجيه الكاميرا الى الباركود الخاص بالشاحنة'),
            ),
