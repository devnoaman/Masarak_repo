...
void main() {
  runApp(const MaterialApp(home: ControllerPage()));
}
...
class _ControllerPageState extends State<ControllerPage> {
  ...
  void _onButtonPressed(String action) {
    Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => ResultScreen(buttonText: action)),
    );
  }
      ...
      appBar: AppBar(
        ...
        leading: IconButton(
          ...
          onPressed: () {
            Navigator.pop(
              context,
            ); // Navigating back to the previous page (menu page).
          },
        ),
      ),
      body: Center(
