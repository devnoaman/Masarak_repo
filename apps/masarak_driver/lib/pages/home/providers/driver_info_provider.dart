...
import 'package:masarak_driver/pages/home/controllers/driver_info_controller.dart';
...
final driverInfoProvider =
    StateNotifierProvider<DriverInfoNotifier, GlobalState<DriverInfo, String>>((
      ...
      return DriverInfoNotifier(ref, dio);
    });
...
class DriverInfoNotifier
  ...
  final Ref ref;
  final Dio dio;
  DriverInfoNotifier(this.ref, this.dio) : super(GlobalState.initial()) {
    get();
  }
