...
import 'package:masarak_driver/pages/notifications/providers/qr_codes_table.dart';
...
final busherProvider = Provider<NotificationsNotifier>((ref) {
  var appContext = ref.watch(driverAppCtxProvider);

  return NotificationsNotifier(ref: ref, ctx: appContext.currentState?.context);
});
...
// final beamsProvider = Provider((ref) async {
//   var appContext = ref.read(appCtxProvider);
//   if (appContext.currentState?.context != null) {
//     await PusherBeams.instance.onMessageReceivedInTheForeground((
//       Map<Object?, Object?> data,
//     ) {
//       log(data["title"].toString());
//       log(data["body"].toString());
//       showTopSnackBar(
//         Overlay.of(appContext.currentState!.context),
//         CustomSnackBar.success(message: 'message'),
//       );
//     });
//   }
