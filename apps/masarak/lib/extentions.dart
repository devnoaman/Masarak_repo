...
extension DateFormation on DateTime {
  ...
  String get dateTime => DateFormat('dd-MM-yyyy / hh:mm a', 'ar-IQ').format(
        this,
      );
}
...
extension Paddinator on num {
  ...
  EdgeInsets get leftPadding => EdgeInsets.only(
        left: toDouble(),
      );
  EdgeInsets get rightPadding => EdgeInsets.only(
        right: toDouble(),
      );
  EdgeInsets get topPadding => EdgeInsets.only(
        top: toDouble(),
      );
  EdgeInsets get bottomPadding => EdgeInsets.only(
        bottom: toDouble(),
      );
  EdgeInsets get hPadding => EdgeInsets.symmetric(
        horizontal: toDouble(),
      );
  EdgeInsets get vPadding => EdgeInsets.symmetric(
        vertical: toDouble(),
      );
}
